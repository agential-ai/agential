...
class ActReAgent(BaseAgent):
    ...
    def synthesize_reason(self, observation: str, action: str) -> str:
        ...
        reason = self.llm.generate([{"role": "user", "content": prompt}]).content
...
class ActreReActAgent(BaseAgent):
    ...
    def sample_alternative_action(action: str) -> str:
        ...
        if action_type.lower() == "search":
            ...
            alternative_actions = [action]  # Keep the original action if it's not "Search" or "Lookup"
