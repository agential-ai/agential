...
def reflexion_act(
    ...
    This function appends an action to the scratchpad by using the _prompt_cot_agent function
...
def reflexion_observe(
    ...
    Args:
        action_type (str): The type of action to be taken, expected to be 'finish' when completing a response.
        answer (str): The answer string generated by the agent for a particular question.
        key (str): The ground truth answer for a particular question, used for validation.
        scratchpad (str): The current scratchpad content, which logs the agent's thought process and actions.
