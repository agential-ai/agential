"""Run Standard on TriviaQA."""
import numpy as np
from agential.eval.metrics.classification import EM, f1, fuzzy_EM, precision, recall
import os
import pickle
...
if __name__ == '__main__':
    ...
    for instance in data:
        ...
        # Update tables.
        eval_table_data.append([question, str(answers), out.answer, is_correct, is_correct_fuzzy, precision_score, recall_score, f1_score])
    ...
    eval_table = wandb.Table(data=eval_table_data, columns=["question", "answer", "predicted_answer", "EM", "fuzzy_EM", "precision", "recall", "f1"])
