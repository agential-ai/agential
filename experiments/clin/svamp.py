...
from agential.agents.clin.prompts import CLIN_ADAPT_META_SUMMARY_SYSTEM, CLIN_ADAPT_SUMMARY_SYSTEM, CLIN_INSTRUCTION_SVAMP, CLIN_META_SUMMARY_INSTRUCTION_SVAMP, CLIN_SUMMARY_INSTRUCTION_SVAMP
