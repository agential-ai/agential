...
def test_reflexion_cot_reflect() -> None:
    ...
    assert reflection_str == gt_reflection_str
    assert reflection_metrics == PromptMetrics(prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)
