...
def test_generate() -> None:
    ...
    # Test num_retries=2.
    gt_out = StandardOutput(answer=[['Paris', 'Paris', 'Paris', 'Paris'], ['Paris', 'Paris', 'Paris', 'Paris']], total_prompt_tokens=80, total_completion_tokens=160, total_tokens=240, total_prompt_cost=0.00012, total_completion_cost=0.00031999999999999997, total_cost=0.0004399999999999999, total_prompt_time=4.0, total_time=0.5, additional_info=[[StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text="Let's think step by step. The capital of France is Paris. So, the answer is Paris.\nAction: Finish[Paris]", prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)), StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text='Finish[Paris]', prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)), StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text="Let's think step by step. The capital of France is Paris, so the answer is Paris.\nAction: Finish[Paris]", prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)), StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text='Finish[Paris]', prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5))], [StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text="Let's think step by step. The capital of France is Paris. So, the answer is Paris.\nAction: Finish[Paris]", prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)), StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text='Finish[Paris]', prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)), StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text="Let's think step by step. The capital of France is Paris, so the answer is Paris.\nAction: Finish[Paris]", prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)), StandardStepOutput(answer='Paris', answer_response=Response(input_text='', output_text='Finish[Paris]', prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5))]])
    responses = [
