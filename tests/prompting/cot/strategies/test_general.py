...
def test_generate() -> None:
    ...
    # Test num_retries=2.
    gt_out = CoTOutput(answer=['Paris', 'Paris'], total_prompt_tokens=40, total_completion_tokens=80, total_tokens=0, total_prompt_cost=6e-05, total_completion_cost=0.00015999999999999999, total_cost=0.0, total_prompt_time=2.0, total_time=0.5, additional_info=[CoTStepOutput(thought="Let's think step by step. The capital of France is Paris. So, the answer is Paris.", answer='Paris', thought_response=Response(input_text='', output_text="Let's think step by step. The capital of France is Paris. So, the answer is Paris.\nAction: Finish[Paris]", prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5), answer_response=Response(input_text='', output_text='Finish[Paris]', prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5)), CoTStepOutput(thought="Let's think step by step. The capital of France is Paris, so the answer is Paris.", answer='Paris', thought_response=Response(input_text='', output_text="Let's think step by step. The capital of France is Paris, so the answer is Paris.\nAction: Finish[Paris]", prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5), answer_response=Response(input_text='', output_text='Finish[Paris]', prompt_tokens=10, completion_tokens=20, total_tokens=30, prompt_cost=1.5e-05, completion_cost=3.9999999999999996e-05, total_cost=5.4999999999999995e-05, prompt_time=0.5))])
    responses = [
