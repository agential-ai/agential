...
def test_heval_generate() -> None:
    ...
    gt_out = CoTOutput(
        ...
        additional_info=[
            CoTStepOutput(
                thought="We need to iterate through the list of numbers and compare each pair to see if any two numbers are closer to each other than the given threshold.",
                answer="```python\n\ndef has_close_elements(numbers: List[float], threshold: float) -> bool:\n    for i in range(len(numbers)):\n        for j in range(i + 1, len(numbers)):\n            if abs(numbers[i] - numbers[j]) < threshold:\n                return True\n    return False\n\n```",
                thought_response=Response(
                    input_text="",
                    output_text="We need to iterate through the list of numbers and compare each pair to see if any two numbers are closer to each other than the given threshold.\n\nFinish\n```python\ndef has_close_elements(numbers: List[float], threshold: float) -> bool:\n    for i in range(len(numbers)):\n        for j in range(i+1, len(numbers)):\n            if abs(numbers[i] - numbers[j]) < threshold:\n                return True\n    return False\n```",
                    prompt_tokens=10,
                    completion_tokens=20,
                    total_tokens=30,
                    prompt_cost=1.5e-05,
            ...
            CoTStepOutput(
                thought="We need to iterate through the list of numbers and compare each pair to check if their difference is less than the threshold.",
                answer="```python\n\ndef has_close_elements(numbers: List[float], threshold: float) -> bool:\n    for i in range(len(numbers)):\n        for j in range(i+1, len(numbers)):\n            if abs(numbers[i] - numbers[j]) < threshold:\n                return True\n    return False\n\n```",
                thought_response=Response(
                    input_text="",
                    output_text="We need to iterate through the list of numbers and compare each pair to check if their difference is less than the threshold.\n\nFinish\n```python\ndef has_close_elements(numbers: List[float], threshold: float) -> bool:\n    for i in range(len(numbers)):\n        for j in range(i+1, len(numbers)):\n            if abs(numbers[i] - numbers[j]) < threshold:\n                return True\n    return False\n```",
                    prompt_tokens=10,
                    completion_tokens=20,
                    total_tokens=30,
                    prompt_cost=1.5e-05,
