"""Self-Refine math agent and strategies."""
...
class SelfRefineMath(BaseMethod):
    def __init__(
        self,
        llm: BaseLLM,
        benchmark: str,
    ...
    def halting_condition(self, answer: str) -> bool:
        ...
        # Compare with previous answer using numeric EM
    ...
    def generate(
        ...
        for idx in range(1, max_iters + 1):
            ...
            if idx == 1:
                ...
                # For math/code, extract code block if present
