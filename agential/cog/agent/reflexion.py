...
class ReflexionReActOutput(BaseModel):
    """The output of the ReflexionReAct agent.

    Attributes:
        is_correct (bool): Whether the answer is correct.
        answer (str): The generated answer.
        output (List[Tuple[str, str, str]]): The list of thought-action-observation tuples.
    """

    is_correct: bool = Field(..., description="Whether the answer is correct.")
    answer: str = Field(..., description="The generated answer.")
    output: List[Tuple[str, str, str]] = Field(
        ...,
        description="The list of thought-action-observation tuples.",
    )
