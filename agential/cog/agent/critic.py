...
class CriticPydanticOutput(BaseModel):
    ...
    Attributes:
        ...
        query: str = Field(..., description = "xxxx by the agent.")
        search_result: str = Field(..., description = "xxxx by the agent.")
        revised_answer: str = Field(..., description = "xxxx by the agent.")
