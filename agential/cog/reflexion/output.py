...
class ReflexionCoTStepOutput(BaseModel):
    ...
    Attributes:
        ...
        thought_metrics (PromptInfo): Thought metrics.
        action_metrics (PromptInfo): Action metrics.
        reflection_metrics (Optional[PromptInfo]): Reflection metrics.
    """
    ...
    thought_metrics: PromptInfo = Field(..., description="Thought metrics.")
    action_metrics: PromptInfo = Field(..., description="Action metrics.")
    reflection_metrics: Optional[PromptInfo] = Field(
...
class ReflexionReActReActStepOutput(BaseModel):
    ...
    is_correct: bool = Field(..., description="Indicates if the action was correct.")
    thought_metrics: PromptInfo = Field(
        ..., description="Prompt metrics for the thought."
    )
    action_metrics: PromptInfo = Field(
        ..., description="Prompt metrics for the thought."
    )
...
class ReflexionReActStepOutput(BaseModel):
    ...
    Attributes:
        ...
        reflection_metrics (Optional[PromptInfo]): Prompt metrics for reflection.
    """
