...
class ReActStepOutput(BaseModel):
    ...
    Attributes:
        ...
        thought_metrics (PromptInfo): The thought metrics including token usage, cost, and latency.
        action_metrics (PromptInfo): The action metrics including token usage, cost, and latency.
    """
