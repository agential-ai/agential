...
class ReActStepOutput(BaseModel):
    ...
    Attributes:
        ...
        thought_metrics (PromptMetrics): The thought metrics including token usage, cost, and latency.
        action_metrics (PromptMetrics): The action metrics including token usage, cost, and latency.
    """
