...
class ReActStepOutput(BaseModel):
    ...
    Attributes:
        ...
        thought_metrics (Response): The thought metrics including token usage, cost, and latency.
        action_metrics (Response): The action metrics including token usage, cost, and latency.
    """
