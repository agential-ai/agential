...
class ReActCodeStrategyOutput(BaseModel):
    ...
    answer: str = Field(..., description="The answer of the code generation problem.")
...
class ReActCodeStrategy(ReActBaseStrategy):
    ...
    def create_output_pydantic(
        ...
        Returns:
            ReActMathStrategyOutput: A Pydantic model containing the thought, action type, query, observation, and answer.
        """
        return ReActCodeStrategyOutput(
            thought=thought,
