...
class ReActMathStrategyOutput(BaseModel):
    ...
    Attributes:
        ...
        answer (str): The answer stored by the agent.
    """
    ...
    answer: str = Field(
        ..., description="The answer of the math problem stored by the agent"
    )
...
class ReActMathStrategy(ReActBaseStrategy):
    ...
    def create_output_pydantic(
        ...
        """
        return ReActMathStrategyOutput(
            thought=thought,
