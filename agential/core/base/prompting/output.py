...
class BasePromptingOutput(BaseModel):
    """Base class for structured prompting method outputs.

    Attributes:
        answer (Any): The answer generated by the prompting method.
    ...
    answer: Any = Field(..., description="The answer generated by the prompting method.")
    ...
    total_time: float = Field(
        ..., description="Total time for the prompting method to finish generating in seconds."
    )
